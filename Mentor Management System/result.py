...
#===========Widgets========
        ...
        txt_name=Entry(self.root,textvariable=self.var_name,state='readonly',font=("goudy old style",20,"bold"),bg="#F1F1F0").place(x=280,y=160,width=320)       
        txt_course=Entry(self.root,textvariable=self.var_course,state='readonly',font=("goudy old style",20,"bold"),bg="#F1F1F0").place(x=280,y=220,width=320)       
        txt_marks=Entry(self.root,textvariable=self.var_marks,font=("goudy old style",20,"bold"),bg="#F1F1F0").place(x=280,y=280,width=320)       
        txt_full_marks=Entry(self.root,textvariable=self.var_full_marks,font=("goudy old style",20,"bold"),bg="#F1F1F0").place(x=280,y=340,width=320)       
   
#=========Buttons==================
        self_add=Button(self.root,text="Add",font=("times new roman",15),bg="lightgreen",activebackground="lightgreen",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        self_clear=Button(self.root,text="Clear",font=("times new roman",15),bg="lightgrey",activebackground="lightgrey",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)

#=========BG-Image=================
        self.bg_img=Image.open("images/rsult.jpg")
