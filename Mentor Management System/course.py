...
#========Entry Fields========
        self.txt_courseName=Entry(self.root,textvariable=self.var_course,font=("goudy old style",15,"bold"),bg="#F1F1F0")
        self.txt_courseName.place(x=150,y=60,width=200)        
        txt_duration=Entry(self.root,textvariable=self.var_duration,font=("goudy old style",15,"bold"),bg="#F1F1F0").place(x=150,y=100,width=200)        
        txt_charges=Entry(self.root,textvariable=self.var_charges,font=("goudy old style",15,"bold"),bg="#F1F1F0").place(x=150,y=140,width=200)        
        self.txt_description=Text(self.root,font=("goudy old style",15,"bold"),bg="#F1F1F0")
...
#=====Search Pannel==========
        ...
        txt_search_courseName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,"bold"),bg="#F1F1F0").place(x=870,y=60,width=180)       
...
#========Content============
        ...
        self.CourseTable.column("name",width=95)
        self.CourseTable.column("duration",width=95)
        self.CourseTable.column("charges",width=95)
